class AsignaturasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @asignatura.save
        format.html { redirect_to asignatura_url(@asignatura), notice: "Asignatura was successfully created." }
  ...
  def update
    respond_to do |format|
      if @asignatura.update(asignatura_params)
        format.html { redirect_to asignatura_url(@asignatura), notice: "Asignatura was successfully updated." }
